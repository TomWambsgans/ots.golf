...
2^115 cuts, within a key-generation budget of 1024 units.
...
VALUE_BITS, BLOCK, MAX_NODES, KEYGEN_BUDGET, INDEX_BITS = 128, 512, 41, 1024, 512
NEED = 2 ** 115
...
def main():
    ...
    print(f"overhead {oh}: index hash {idx} unit(s); {len(results)} shapes within budget; best verification cost "
