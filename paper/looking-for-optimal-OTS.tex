...
The theorem is kernel-checked in the \texttt{Upper} submission root. Its exported declarations are \texttt{scheme}, \texttt{secure}, and \texttt{cost}, in namespace \texttt{OptimalOTS.}\allowbreak\texttt{Challenge.Upper}.
...
\end{center}
The main modules of the \texttt{Lower} submission root are:
\begin{center}
\begin{tabular}{ll}
