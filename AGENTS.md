...
formal/                      the Lean project (lake root)
  ...
  Submissions/RiscvUpper/       RISC-V upper bound root; verified RV64IM verifier, claim 9041
...
- **RISC-V upper bound** (`riscv-upper`): an OTS meeting the Upper bound requirements, together
  ...
  the checked construction costs 9041. Proofs live in `formal/Submissions/RiscvUpper/`; see
  `docs/riscv-upper.md`.
