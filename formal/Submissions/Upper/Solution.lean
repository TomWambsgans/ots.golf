...
/-!
# Upper track: the flat scheme, 109 units
...
* `Submissions.Upper.Scheme`: `Forest.forestScheme : Scheme paperParams`, every signature
  verifies in `109` units (`forestScheme_verifyCost`);
...
/-- **Cost.** Every signature of the scheme verifies in at most `109` hash units. -/
