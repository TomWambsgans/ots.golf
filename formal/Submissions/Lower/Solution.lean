...
import Submissions.Lower.PatternAssembly
...
theorem Challenge.Lower.candidate : VerificationLowerBound paperParams 18 :=
  verificationLowerBound_paper

end OptimalOTS

/--
info: 'OptimalOTS.Challenge.Lower.candidate' depends on axioms: [propext, Classical.choice, Quot.sound]
-/
#guard_msgs in
#print axioms OptimalOTS.Challenge.Lower.candidate
