...
execution costs at most 1628 cycles: one cycle per executed instruction, two for the 912-bit root
hash, with each chain block charged by the path actually taken (267 cycles for the index phase and
