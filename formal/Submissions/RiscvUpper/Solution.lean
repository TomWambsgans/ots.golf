...
/-! A fixed-layout forest OTS with an equivalent RV64IM verifier, at 5513 accepting cycles. -/
...
refinement on every input, and at most 5513 cycles on every accepting path. -/
theorem certificate : submission.Certificate 5513 := RiscvUpperForest.machineCertificate
