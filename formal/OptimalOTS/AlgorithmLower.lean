import OptimalOTS.AlgorithmZeroQuery
...
namespace OptimalOTS.GenericLower
...
theorem win_not_zero (oa : OracleComp (Spec P) Bool) (h : CostAtMost P oa 0) (c : Cache P) :
  ...
  rw [bind_pure_comp]
  rw [win_zero P _ (AlgorithmCosts.CostAtMost.map h _)]
  simp [freeRun]
...
theorem attack_cost [Nonempty S.Signature] (m₀ m₁ : Message P) (hm : m₀ ≠ m₁)
  ...
  refine AlgorithmCosts.CostAtMost.bind hk fun k => ?_
  exact AlgorithmCosts.CostAtMost.bind_le (hs k.2 m₀) (fun _ => hz _ _ _) (by omega)
