...
**9041-cycle RV64IM verifier** for a fixed-layout forest OTS: the machine's oracle computation is
proved equal to the Lean verifier on every input, every execution terminates, and accepting
executions cost at most 9041 cycles. The original DAG and historical partial-disclosure
