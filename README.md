...
**5513-cycle RV64IM verifier** for a nibble-layout forest OTS: the machine's oracle computation is
proved equal to the Lean verifier on every input, every execution terminates, and accepting
executions cost at most 5513 cycles. The original DAG and historical partial-disclosure
